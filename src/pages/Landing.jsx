    ...
    <div className="px-14 py-[14px]  text-white sm:px-[10px]  sm:py-[40%] md:py-[100px] ">
        ...
        <div className='flex  h-contain sm:h-[300px]  mt-[70px] sm:mt-[70px] '>
            <div className='border-l px-[20px] border-r w-[370px]  py-[40px]'>
                ...
                <p className='hidden sm:block sm:text-[16px]'> I enjoy meeting random people and help<br></br> where I can. My open calendar is here</p>
            </div>
            <div className='border-r px-[20px] py-[40px] w-[370px]'>
                ...
                <p className='hidden sm:block sm:text-[16px]'>Don’t know me yet? My Name’s Abdull, and<br></br> I’m a UX Designer based in Kaduna, Nigeria.</p>
            </div>
